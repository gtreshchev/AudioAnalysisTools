...
#include "EnvelopeAnalysisLibrary.generated.h"

/**
 * Possible envelope analysis results
 */
UENUM(BlueprintType, Category = "Envelope Analysis")
enum class EEnvelopeAnalysisStatus : uint8
{
...
struct FEnvelopeAnalysisStruct
{
	...
	FEnvelopeAnalysisStruct()
		: NumberOfChannels(0), SampleRate(44100.0f), EnvelopeAnalysisFrameSize(1024), AttackTimeMSec(10.0f),
		  ReleaseTimeMSec(100.0f), EnvelopeMode(EEnvelopeMode::Squared), bIsAnalog(true)
	{
	}

	/** Custom constructor */
	FEnvelopeAnalysisStruct(int32 InNumberOfChannels, float InSampleRate, int32 InEnvelopeAnalysisFrameSize,
	                        float InAttackTimeMSec, float InReleaseTimeMSec, EEnvelopeMode InEnvelopeMode,
	                        bool InbIsAnalog)
...
class ENVELOPEANALYSIS_API UEnvelopeAnalysisLibrary : public UObject
{
	GENERATED_BODY()

	UEnvelopeAnalysisLibrary();
...
public:
	...
	static UEnvelopeAnalysisLibrary* CreateEnvelopeAnalysis();
